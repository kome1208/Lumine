...
import 'package:lumine/features/account/data/char_master_provider.dart';
import 'package:lumine/features/account/data/role_combat_provider.dart';
                            ...
                            ListTile(
                              ...
                              onTap: () {
                                showModalBottomSheet(
                                  ...
                                  clipBehavior: Clip.hardEdge,
                                  builder: (context) {
                                    return _PerformanceDetails(roundData: round);
                                  }
                                );
                              },
                            ),
